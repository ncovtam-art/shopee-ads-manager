  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-[var(--muted-foreground)] mt-1">Quản lý nhân viên, phân quyền, theo dõi hiệu quả</p>
      </div>
      <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-12 text-center">
        ...
        <h2 className="text-lg font-semibold mb-2">Module Nhân viên</h2>
        <p className="text-sm text-[var(--muted-foreground)] max-w-md mx-auto">
          Quản lý nhân viên, phân quyền, theo dõi hiệu quả. Đang được phát triển trong Phase 2.
        </p>
