  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-[var(--muted-foreground)] mt-1">Cảnh báo ROI âm, Page lỗ, chưa đối chiếu</p>
      </div>
      <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-12 text-center">
        ...
        <h2 className="text-lg font-semibold mb-2">Module Thông báo</h2>
        <p className="text-sm text-[var(--muted-foreground)] max-w-md mx-auto">
          Cảnh báo ROI âm, Page lỗ, chưa đối chiếu. Đang được phát triển trong Phase 2.
        </p>
